...
//Simplest case is BLOCKS*BLOCKS=MAXSIZE.
const int BLOCKS = 32;
...
const int CELLX = 1024;
const int CELLY = 1024;
...
__global__ void evolve_c_state(particle*, cell*, curandState*, int*, int*);
